...
function kollektiv_customize_register( $wp_customize ) {
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial( 'blogname', array(
			...
			'render_callback' => 'kollektiv_customize_partial_blogname',
		) );
		$wp_customize->selective_refresh->add_partial( 'blogdescription', array(
			'selector'        => '.site-description',
			'render_callback' => 'kollektiv_customize_partial_blogdescription',
		) );
	}
}
 ...
 * @return void
 */
function kollektiv_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function kollektiv_customize_partial_blogdescription() {
